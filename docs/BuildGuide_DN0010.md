...
1. すべてのスイッチプレート裏面にゴムシートを貼りつける

    ゴムシートをスイッチプレートの横幅より少し短い長さに切断します。  
    切断した部分を、さらに縦半分に切断して、細長いゴムシートを作ります。  
    これを、スイッチプレートの太い部分に貼りつけます。

    また、スイッチプレートのスイッチとスイッチの間にある、細い部分の長さに合わせてゴムシートを切断し、これを貼りつけます。

    すべてのスイッチプレートに、バランスよく貼り付けます。

    💡ヒント：スイッチプレートの裏面に、`だいたい`バランスよく貼り付けてあれば大丈夫です。裏面のすべてに、きっちりと貼り付けようとすると、ゴムシートが足りなくなります。

    スイッチプレートへのゴムシート貼り付け例
    ![スイッチプレートへのゴムシート貼り付け例](/assets/BuildGuide_DN0010/IMG_5255.jpeg)
