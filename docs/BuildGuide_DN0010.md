...
1. うら側から、`プレート用フォーム`を貼る（6個）

    各種パーツやネジ穴に重ならない位置へ、`プレート用フォーム`を貼ります。  
...
1. おもて側から、ワッシャーを挟んだナットを長いネジでとめる。（8箇所）
...
1. うら側の空いたスペースに`ゴムシート（2mm）`を貼る
    ...
    **☠️異なる厚さのゴムシートを貼ると、正しく組み立てられません。**
    ...
    ![基板Mid中央うら側にゴムシートを貼った様子](/assets/BuildGuide_DN0010/IMG_5239.jpeg)

### 基板Mid左右の準備

1. `基板Mid左右`2枚のうち、ひとつを「R Back」と書かれた面が見えるように、またもうひとつを「L Back」と書かれた面が見えるように置く。

1. ダイオードを取り付ける（それぞれ2個、計4個）

1. スイッチソケットを取り付ける（それぞれ2個、計4個）

1. おもて側から、ワッシャーを挟んだナットを長いネジでとめる。（それぞれ4箇所、計8箇所）
...
1. うら側から、スイッチソケットを取り付ける（32個、または33個）
...
1. 基板Baseと基板Mid中央を組み合わせる
    ...
    基板Baseのうら側から、基板Mid中央のネジを`ナット`で止めます。（8箇所）
    ...
    基板Midのおもて側から、`長いスペーサー`を取り付けます。（2箇所）
...
1. 基板Baseと基板Mid左右を組み合わせる
    ...
    基板Baseのうら側から、基板Mid左右のネジを`ナット`で止めます。（ぞれぞれ4箇所、計8箇所）
...
1. 基板Topと基板Mid中央を組み合わせる
    ...
    基板Topのおもて側から、基板Midを`短いネジ`で止めます（6箇所）
...
1. すべてのスイッチプレート裏面に`ゴムシート（1mm）`を貼る
    ...
    **☠️異なる厚さのゴムシートを貼ると、正しく組み立てられません。**
    ...
    💡ヒント：スイッチプレートの裏面に、*だいたい*　*バランスよく*　貼ってあれば大丈夫です。裏面のすべてを埋めるように貼ると、ゴムシートが足りなくなります。

    💡ヒント：インジケータLEDを使用する場合は、ゴムシートをLED光透過穴を囲うように貼って光線漏れを防ぐと、LED光が綺麗に見えます。
...
1. `ボトムプレート`うら側から、`短いネジ`で止める（11箇所）
